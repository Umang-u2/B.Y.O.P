...
public class GoogleAIController {
   ...
   /* public GoogleAIController(VertexAiGeminiChatModel chatModel){
        this.chatClient = ChatClient.create(chatModel);
    }*/

    ChatMemory chatMemory = MessageWindowChatMemory.builder().build();

    public GoogleAIController(ChatClient.Builder builder) {
    ...
    public ResponseEntity<String> getAnswers(@PathVariable String message){
        ...
        String modelName = chatResponse
                .getMetadata()
                .getModel();

        return ResponseEntity.ok(chatResponse.getResult()
                .getOutput()
                .getText());
    }
    ...
    public String recommend(@RequestParam String type, @RequestParam String year, @RequestParam String lang){
        ...
        String tempt = """
                I want to watch a {type} movie tonight with good IMDB rating.
                Looking for movies around year {year}.
                The language I am looking for is {lang}.
                
                Suggest one specific movie and tell me the cast and runtime of the movie as well. 
